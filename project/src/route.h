...
class Route {
 public:
  ...
  /**
  * @brief Move the destination pointer to point to the next stop
  * This function will be used for bus Move function.
  */
  void ToNextStop();  // Change destination_stop_ to next stop, refactor name
