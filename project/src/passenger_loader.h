...
class PassengerLoader {
  ...
  * This function will be used for Bus factory to generate new small bus
  *
  * @param[in] new_passenger new passenger
  * @param[in] max_pass maximum passenger size
  * @param[in] passengers a list of already loaded passengers
  *
  * @return boolean, whether this new passenger is loaded or not
  */
